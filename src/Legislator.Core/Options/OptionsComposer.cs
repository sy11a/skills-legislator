...
public static class OptionsComposer
{
    ...
    private static LegislatorOptions Apply(LegislatorOptions o, string key, string value, OptionsLayer layer) =>
        LegislatorOptions.KeyMap[key] switch
        {
            ...
            nameof(LegislatorOptions.OkfIndexFile) => o with { OkfIndexFile = new(value, layer) },
            nameof(LegislatorOptions.CodebaseMapFile) => o with { CodebaseMapFile = new(value, layer) },
            nameof(LegislatorOptions.GlossaryFile) => o with { GlossaryFile = new(value, layer) },
            nameof(LegislatorOptions.AdrTemplateFile) => o with { AdrTemplateFile = new(value, layer) },
            nameof(LegislatorOptions.ReadmeFile) => o with { ReadmeFile = new(value, layer) },
            nameof(LegislatorOptions.GitDir) => o with { GitDir = new(value, layer) },
            nameof(LegislatorOptions.LegacyHomeDir) => o with { LegacyHomeDir = new(value, layer) },
            nameof(LegislatorOptions.LegacyHomeSubdirs) => o with { LegacyHomeSubdirs = new(List(value), layer) },
            nameof(LegislatorOptions.JournalRecencyDays) => o with { JournalRecencyDays = new(Integer(value), layer) },
            nameof(LegislatorOptions.ForeignStructures) => o with { ForeignStructures = new(List(value), layer) },
            nameof(LegislatorOptions.SkillHomes) => o with { SkillHomes = new(List(value), layer) },
            nameof(LegislatorOptions.SkillsRuleFile) => o with { SkillsRuleFile = new(value, layer) },
            nameof(LegislatorOptions.SkillRulesPath) => o with { SkillRulesPath = new(value, layer) },
            nameof(LegislatorOptions.ArmExecutable) => o with { ArmExecutable = new(value, layer) },
            nameof(LegislatorOptions.SkillReleaseFile) => o with { SkillReleaseFile = new(value, layer) },
            ...
            nameof(LegislatorOptions.CaseBranchPrefixes) => o with { CaseBranchPrefixes = new(List(value), layer) },
