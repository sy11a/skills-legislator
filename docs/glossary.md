...
| baseline | The generated answer to "what must the system do today": `baseline.md`, regenerated from EARS ids (R-NNN) ↔ annotated tests. Do-not-edit; a deleted test is a deleted line, visible in the diff. Rot-proof by construction. | coin | `docs/ai/baseline.md` (generated; BL-033, pilot kbo) |
